...
public class instructionStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 72, 1280, 10));

        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Monospaced", 1, 25)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("Exam Instruction is as per follows:\n1. The examination will comprise of Objective type Multiple Choice Questions (MCQs)\n2. Each questions carries One mark.\n3. The total number of questions, duration of examination, will be different based \n   on the course, the detail is available on your screen.\n4. The Subjects or topics covered in the exam will be as per the Syllabus.\n5. There will be NO NEGATIVE MARKING for the wrong answers.\n\n\n\n\nNumber of Questions: 10\nExam Duration: 10 min\nAll the Best !");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 88, 1257, 497));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(407, 621, 510, -1));
